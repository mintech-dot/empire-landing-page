    ...
    <section>
      <div className="container px-[229px] py-24 mx-auto pt-[166px]">
        <div className="text-center mb-20">
          ...
          <h1 className=" text-[18px] font-poppins font-semibold text-metal pt-4">
            {getstarted.subtitle}
          </h1>
